...
| **Summary** | AI-generated text summary of spending habits |
...
- **AI Chat moved to Dashboard** — the chat entry point is an inline banner with a robot illustration on the Dashboard, not a nav link, to encourage discovery
